...
<html>
	...
	<body>
		...
		<form:form method="POST" action="/SpringHBApp/save.html?result=save">
	   		<table>
			    <tr>
	...
	<table align="left" border="1">
		...
		<c:forEach items="${employees}" var="employee">
			<tr>
				...
				<td align="center"><a href="edit.html?id=${employee.id}&result=edit">Edit</a> | <a href="delete.html?id=${employee.id}">Delete</a></td>
			</tr>
		</c:forEach>
	</table>
</c:if>
